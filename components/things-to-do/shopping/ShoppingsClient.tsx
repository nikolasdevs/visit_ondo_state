...
export default function AllShoppingsClient({ data }: { data: Data }) {
  const [shoppings] = useState<Shopping[]>([]);
        ...
        <div className="flex flex-col gap-8  w-full">
          <div className="  grid gap-8 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 justify-center">
            {data.shoppings.map((shopping) => (
              ...
              >
                <Link
                  href={`/things-to-do/shoppings/${shopping.slug}`}
                  className=""
                >
                ...
                <div className="pt-2 flex flex-col justify-between h-32 gap-2">
                  <div className="flex flex-col gap-2 ">
                    <Link href={`/things-to-do/shoppings/${shopping.slug}`}>
