...
export default function AllFoodDrinksClient({ data }: { data: Data }) {
  const [foodDrinks] = useState<FoodDrinks[]>([]);
  const [currentPage, setCurrentPage] = useState(1);
  const [itemsPerPage] = useState(8);
  //const lastItemIndex = currentPage * itemsPerPage;
  //const firstItemIndex = lastItemIndex - itemsPerPage;
  // const currentItems = foodDrinks.slice(firstItemIndex, lastItemIndex);
  return (
    <>
              ...
              >
                ...
                <div className="pt-2 flex flex-col justify-between h-32 gap-2">
                  <div className="flex flex-col gap-2 ">
                    <Link href={`/things-to-do/foodDrinks/${foodDrink.slug}`}>
